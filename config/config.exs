...
config :wages, WagesWeb.Endpoint,
  ...
  pubsub_server: Wages.PubSub,
  live_view: [signing_salt: "GTYo9N5u"]
...
config :wages, Wages.Mailer, adapter: Swoosh.Adapters.Local
